...
Adapted from scenario-02 backend.
"""
...
class TTSService:
    ...
    @classmethod
    def generate_audio(cls, text: str, voice_id: str = "en-carter") -> bytes:
        """Generate audio from text using the specified voice. Returns WAV bytes."""
